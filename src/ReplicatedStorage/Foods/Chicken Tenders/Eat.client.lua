...
tool.Activated:Connect(function()
	...
	if not eating then
		...
		anim = Players.LocalPlayer.Character.Humanoid:LoadAnimation(tool.Animation)
		anim:Play()
		...
		msh.MeshId = "rbxassetid://17085238831"
		msh.TextureId = "rbxassetid://17085238918"
		...
		wld.Part0 = chip
		wld.Part1 = hand
		wld.C0 = CFrame.new() * CFrame.Angles(math.rad(90), math.rad(90), math.rad(45)) + Vector3.new(0, -.1, -.2)
		wld.Parent = chip
